...
#include "../FolhaPagemento/cadastro.h"
...
static const char qt_meta_stringdata_Cadastro[] = {
    "Cadastro\0\0on_radioButton_clicked()\0"
...
const QMetaObjectExtraData Cadastro::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Cadastro::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Cadastro,
      qt_meta_data_Cadastro, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Cadastro::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cadastro))
